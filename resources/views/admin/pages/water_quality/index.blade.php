            ...
            <div class="row">
                ...
                <div class="bg-white col-lg-10 pt-2">
                    <div class="button-action mb-3">
                        <a href="{{ route('admin.water_quality.create') }}" class="btn btn-primary">Thêm mới</a>
                    </div>
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th class="bg-primary text-white" scope="col">Mức độ pH</th>
                                <th class="bg-primary text-white" scope="col">Tổng chất rắn hòa tan </th>
                                <th class="bg-primary text-white" scope="col">Loại chất gây ô nhiễm</th>
                                <th class="bg-primary text-white" scope="col">Thời gian đo lường</th>
